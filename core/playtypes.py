# Turnover ypes that can appear without ;
tonosclist = ['illegal screen', 'traveling', '3 sec', 'offensive foul', 'shot clock', 'out of bounds lost ball',
              ...
              'dbl dribble', 'back court', 'turnover', 'lost ball', 'lane violation']
# Turnover types that appear with ;
tosclist = ['bad pass', 'lost ball']
# Shot types
shottypelist = ['layup', 'hook shot', 'dunk', 'jump shot']
# Free throw types
freethrowlist = ['clear path', 'technical', 'flagrant', 'free throw']
# Foul types
foultypelist = ['Double personal', 'Personal', 'Shooting', 'Offensive', 'Technical', 'Personal block', 'Personal take',
                ...
                'Away from play', 'Flagrant', 'Clear path']
# Violation types
